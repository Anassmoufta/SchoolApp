 ...
 <div class="alert alert-success alert-bordered">
    ...
    public static function getSetting($type)
    {
        ...
        if ($setting) {
            ...
            return 'Default description or handle the error as needed';
        }
    ...
    public static function getMarkType($class_type)
    {
        switch($class_type){
            ...
            case 'N' : return 'maternelle';
            case 'P' : return 'primaire';
            case 'PN' : return 'pré-maternelle';
            case 'C' : return 'crèche';
        }
