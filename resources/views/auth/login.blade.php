                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="identity" value="{{ old('identity') }}" placeholder="Identifiant ou e-mail">
                            </div>
                            ...
                            {{-- <div class="form-group">
                                <a href="#" class="btn btn-light btn-block"><i class="icon-home"></i> Retour à l'accueil</a>
                            </div> --}}
                        </div>
                    </div>
                </form>
