    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#new-user" class="nav-link active" data-toggle="tab">Créer un Nouvel
                        Utilisateur</a></li>
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="user_type"> Sélectionner l'Utilisateur : <span
                                                class="text-danger">*</span></label>
                                        <select required data-placeholder="Sélectionner l'Utilisateur"
                                            class="form-control select" name="user_type" id="user_type">
                                            @foreach ($user_types as $ut)
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('name') }}" required type="text" name="name"
                                            placeholder="Nom Complet" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('address') }}" class="form-control" placeholder="Adresse"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="select form-control" id="gender" name="gender" required
                                            data-fouc data-placeholder="Choisir...">
                                            <option value=""></option>
                                            <option {{ old('gender') == 'Male' ? 'selected' : '' }} value="Male">Homme
                                            </option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select data-placeholder="Choisir..." required name="nal_id" id="nal_id"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select onchange="getLGA(this.value)" required data-placeholder="Choisir..."
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select required data-placeholder="Sélectionner l'État d'abord"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span class="form-text text-muted">Images acceptées : jpeg, png. Taille maximale du
                                            fichier 2Mo</span>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        ...
                                                        <a href="{{ route('users.show', Qs::hash($u->id)) }}"
                                                            class="dropdown-item"><i class="icon-eye"></i> Voir le
                                                            Profil</a>
                                                        {{-- Modifier --}}
