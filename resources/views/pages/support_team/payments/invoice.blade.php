    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                <li class="nav-item"><a href="#all-cl" class="nav-link" data-toggle="tab">Paiements complétés</a></li>
            </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <input min="1" max="{{ $uc->balance ?: $uc->payment->amount }}"
                                                        ...
                                                        placeholder="Payer maintenant" title="Payer maintenant"
                                                        name="amt_paid" type="number">
                                                </div>
                                                <div class="col-md-5">
                                                    <button data-text="Payer" class="btn btn-danger" type="submit">Payer <i
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    ...
                                                    <a target="_blank"
                                                        ...
                                                        class="dropdown-item"><i class="icon-printer"></i> Imprimer le reçu</a>
                                                    {{-- PDF Receipt --}}
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    ...
                                                    {{-- Reçu PDF --}}
                                                    {{--                    <a  href="{{ route('payments.pdf_receipts', Qs::hash($uc->id)) }}" class="dropdown-item download-receipt"><i class="icon-download"></i> Télécharger le reçu</a> --}}
