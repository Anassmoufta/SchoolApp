                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mt-4">
                            <div class="text-right mt-1">
                                <button type="submit" class="btn btn-primary">Soumettre <i
                ...
                <tbody>
                    @foreach ($students as $s)
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    <a href="#" class="btn btn-danger" data-toggle="dropdown"> Gérer les paiements <i
                                            class="icon-arrow-down5"></i>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-left">
                                        <a href="{{ route('payments.invoice', [Qs::hash($s->user_id)]) }}"
                                            class="dropdown-item">Tous les paiements</a>
