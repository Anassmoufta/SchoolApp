                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info border-0 alert-dismissible">
                                ...
                                <span>Lorsqu'une classe est créée, une section sera automatiquement créée pour la classe. Vous pouvez la modifier ou ajouter d'autres sections à la classe dans <a target="_blank" href="{{ route('sections.index') }}">Gérer les sections</a></span>
                            </div>
                        </div>
                    </div>
