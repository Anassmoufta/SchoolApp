    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#valid-pins" class="nav-link active" data-toggle="tab">Codes PIN valides</a></li>
                <li class="nav-item"><a href="#used-pins" class="nav-link" data-toggle="tab">Codes PIN utilisés</a></li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center alert alert-info border-0 alert-dismissible">
                                ...
                                <span>Il y a <strong>{{ $pin_count }}</strong> codes PIN valides qui n'ont pas été utilisés</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info border-0 alert-dismissible">
                                ...
                                <div class="text-center">  <span>Un total de <strong>{{ $used_pins->count() }}</strong> code(s) PIN ont été utilisés et peuvent ne plus être valides </span>
                
                                    <a id="used-pins" onclick="confirmDelete(this.id)" href="#" class="btn btn-danger btn-sm ml-2"><i class="icon-trash mr-1"></i> Supprimer TOUS les codes PIN utilisés</a>
