...
@section('page_title', 'Corriger les erreurs de notes')
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><i class="icon-wrench mr-2"></i> Correction par lot </h5>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mt-4">
                        <div class="text-right mt-1">
                            <button type="submit" class="btn btn-danger">Corriger les erreurs <i class="icon-wrench2 ml-2"></i></button>
                        </div>
                    </div>
