...
@section('page_title', 'Sélectionner la feuille de notes de l\'étudiant')
@section('content')
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title"><i class="icon-books mr-2"></i> Sélectionner la feuille de notes de l'étudiant</h5>
        {!! Qs::getPanelOptions() !!}
    </div>
