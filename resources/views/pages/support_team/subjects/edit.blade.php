...
@section('page_title', 'Modifier la matière - '.$s->name. ' ('.$s->my_class->name.')')
@section('content')

<div class="card">
    <div class="card-header header-elements-inline">
        <h6 class="card-title">Modifier la matière - {{$s->my_class->name }}</h6>
        {!! Qs::getPanelOptions() !!}
    </div>
            ...
            <div class="col-md-6">
                <form class="ajax-update" method="post" action="{{ route('subjects.update', $s->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="name" value="{{ $s->name }}" required type="text" class="form-control" placeholder="Nom de la matière">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select required data-placeholder="Sélectionnez une classe" class="form-control select" name="my_class_id" id="my_class_id">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select data-placeholder="Sélectionnez un enseignant" class="form-control select-search" name="teacher_id" id="teacher_id">
                                <option value=""></option>
...
{{-- Fin de la modification de la matière --}}
