<div class="tab-pane fade" id="edit-subs">
    ...
    @if ($tts->count())
                        ...
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title font-weight-bold">
                                    {{ $tt->exam_date ? 'Examen (' . date('D\, d/m/Y', strtotime($tt->exam_date)) . ')' : $tt->day }}
                                    {{ '(' . $tt->time_slot->full . ')' . ' - ' . $tt->subject->name }}</h6>
                                <div class="header-elements">
                                    <div class="list-icons">
                                        <a onclick="confirmDelete(this.id)" href="#" id="{{ $tt->id }}"
                                            title="SUPPRIMER" class="list-icons-item text-danger"><i
                                ...
                                <div class="col-md-12">
                                    <form method="post" action="{{ route('tt.update', $tt->id) }}">
                                        ...
                                        @else
                                            ...
                                            <div class="form-group row">
                                                <label for="day"
                                                    class="col-lg-3 col-form-label font-weight-semibold">Jour <span
                                                        class="text-danger">*</span></label>
                                                <div class="col-lg-9">
                                                    <select id="day" name="day" required type="text"
                                                        class="form-control select"
                                                        data-placeholder="Sélectionnez un jour...">
                                        ...
                                        <div class="form-group row">
                                            <label for="subject_id"
                                                class="col-lg-3 col-form-label font-weight-semibold">Matière <span
                                                    class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                                <select required data-placeholder="Sélectionnez une matière"
                                        ...
                                        <div class="form-group row">
                                            <label for="ts_id"
                                                class="col-lg-3 col-form-label font-weight-semibold">Plage horaire <span
                                                    class="text-danger">*</span></label>
                                            <div class="col-lg-9">
                                                <select data-placeholder="Sélectionnez une heure..." required
        ...
        @endforeach
    @else
        <div class="alert alert-info text-center">Il n'y a aucun enregistrement à afficher. Ajoutez des matières à
            l'emploi du temps et actualisez la page.</div>
    @endif
