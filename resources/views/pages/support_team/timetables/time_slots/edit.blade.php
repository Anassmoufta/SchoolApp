...
@section('page_title', 'Modifier le créneau horaire')
@section('content')
<div class="card">
        ...
        <div class="col-md-6">
            <form method="post" action="{{ route('ts.update', $tms->id) }}">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label font-weight-semibold">Heure de début <span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-3">
                        <select data-placeholder="Méridien" required class="select form-control" name="meridian_from" id="meridian_from">
                            <option value=""></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <select data-placeholder="Méridien" required class="select form-control" name="meridian_to" id="meridian_to">
                            <option value=""></option>
