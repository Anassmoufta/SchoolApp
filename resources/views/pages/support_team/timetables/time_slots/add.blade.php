<div class="row">
    <div class="col-md-12">
        <div class="alert alert-info text-center">
            <span>Vous pouvez ajouter de nouveaux créneaux horaires ou choisir d'utiliser les créneaux horaires
                existants d'un autre emploi du temps. <strong>NB :</strong> L'utilisation de créneaux horaires existants
                réinitialise l'emploi du temps actuel.</span>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <form data-reload="#time_slots_table" class="ajax-store" method="post"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <select data-placeholder="Heure" required class="select-search form-control"
                            ...
                            <div class="col-lg-3">
                                <select data-placeholder="Méridien" required class="select form-control"
                        ...
                        {{-- FIN DU TEMPS --}}
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Heure de fin <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Soumettre le formulaire <i
                ...
                <div class="col-md-12">
                    <form method="post" action="{{ route('ts.use', $ttr->id) }}">
                        ...
                        <div class="form-group">
                            <label for="ttr_id" class="col-form-label-lg font-weight-semibold mb-lg-2">Sélectionnez
                                des créneaux horaires existants <span class="text-danger">*</span></label>

                            <div class="col-lg-8">
                                <select id="ttr_id" data-placeholder="Sélectionnez..." required
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-lg btn-success">Soumettre le formulaire <i
                                    class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
