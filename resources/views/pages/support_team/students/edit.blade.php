    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input name="dob" value="{{ $sr->user->dob }}" type="text" class="form-control date-pick" placeholder="Sélectionnez une date...">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select data-placeholder="Choisissez..." required name="nal_id" id="nal_id" class="select-search form-control">
                    <option value=""></option>
        ...
        <div class="col-md-3">
            ...
            <select onchange="getLGA(this.value)" required data-placeholder="Choisissez..." class="select-search form-control" name="state_id" id="state_id">
                <option value=""></option>
        ...
        <div class="col-md-3">
            ...
            <select required data-placeholder="Sélectionnez l'état d'abord" class="select-search form-control" name="lga_id" id="lga_id">
                @if($sr->user->lga_id)
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select onchange="getClassSections(this.value)" name="my_class_id" required id="my_class_id" class="form-control select-search" data-placeholder="Sélectionnez une classe">
                                    <option value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="section_id" required id="section_id" class="form-control select" data-placeholder="Sélectionnez une section">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select data-placeholder="Choisissez..." name="my_parent_id" id="my_parent_id" class="select-search form-control">
                                    <option value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="year_admitted" data-placeholder="Choisissez..." id="year_admitted" class="select-search form-control">
                                    <option value=""></option>
