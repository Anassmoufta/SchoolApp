                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required id="fs" name="fs" data-placeholder="Sélectionner la classe d'abord" class="form-control select">
                                @if($selected && $fs)
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required id="ts" name="ts" data-placeholder="Sélectionner la classe d'abord" class="form-control select">
                                @if($selected && $ts)
